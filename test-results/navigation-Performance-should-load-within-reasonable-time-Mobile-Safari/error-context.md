...
- Name: Performance >> should load within reasonable time
- Location: F:\WhatsappAutomation\tests\e2e\navigation.spec.ts:160:7

# Error details

```
Error: browserType.launch: Executable doesn't exist at C:\Users\BlackKnight\AppData\Local\ms-playwright\webkit-2158\Playwright.exe
╔═════════════════════════════════════════════════════════════════════════╗
